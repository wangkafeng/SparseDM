...
def train(config):
    ...
    # train_state = utils.initialize_train_state_dit(config, device)  #  fro DiT model
    train_state = utils.initialize_train_state_ddpm(config, device)  
    # nnet, nnet_ema, optimizer, train_dataset_loader = accelerator.prepare(
    #     train_state.nnet, train_state.nnet_ema, train_state.optimizer, train_dataset_loader)  #   for accelerator,  run ASP pass  but error ?
    nnet, nnet_ema, optimizer, train_dataset_loader = train_state.nnet, train_state.nnet_ema, train_state.optimizer, train_dataset_loader  #   run ASP pass but error ?

    print('nnet = ', nnet)
    print('nnet_ema = ', nnet_ema)
...
def main(argv):
    ...
    print('config.config_name = ', config.config_name)
