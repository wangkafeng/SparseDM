...
def conv2d(
    ...
    # )   #  modify
    conv = SparseConv(in_channel, out_channel, kernel_size=kernel_size,  stride=stride, padding=padding, bias=bias, N=2, M=4)  #  pass 
...
def linear(in_channel, out_channel, scale=1, mode="fan_avg"):
    # lin = nn.Linear(in_channel, out_channel)   #  modify
    lin = SparseLinear(in_channel, out_channel, N=2, M=4)
